<?php
    ...
    $query_db = array(
        ...
        "VCL-2"  => 'CALL sp_set_veiculo(@access,@hash,x00,x01,"x02","x03","x04","x05","x06","x07","x08","x09","x10","x11","x12","x13");', //id,id_acervo,nome,ano,modelo,marca,combustivel,configuracao,portas,lugares,porte,placa,procedencia,descricao
